      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            <div class="row tet-justify-center">
              <article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
                <form action="index.php" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="IdActivite" class="form-control" value=" <?php echo $IdActivite ?>" />
                  </div>                  
                  <div class="form-group">                    
                  ...
                  <div class="col-md-12 form-group">  
                    <input type="submit" value="Enregistrer" name="Ajout_Photos" class="btn btn-primary form-control"/>
                  </div> 
