  ...
  <!-- 
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry">
			...
			<article class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col-xxs-12 animate-box">
				<figure>
					<a href="single.php?IMAGE=<?php echo $data['id_P']; ?>"><img src="<?php echo '../../'.$data['photos_P']; ?>" alt="Image" class="img-responsive"></a>
				</figure>
				...
				<span class="fh5co-meta fh5co-date"><?php echo '--'.$data['id_P'];?></span>
			</article>			
