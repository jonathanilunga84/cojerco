  ...
  <!-- 
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry single-entry">
			...
			?>
			<article class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
				<figure class="animate-box">
					<img src="<?php echo '../../'.$data['photos']; ?>" alt="Image" class="img-responsive">
				</figure>
